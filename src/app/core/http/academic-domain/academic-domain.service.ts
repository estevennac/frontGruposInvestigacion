...
export class AcademicDomainService {
  ...
  createAcademicDomainForm(formData: AcademicDomain): Observable<any> {
    return this.http.post(`${this.URL}/create`, formData);
  }

  update(id: number, formData: AcademicDomain): Observable<AcademicDomain> {
    return this.http.put<AcademicDomain>(`${this.URL}/update/${id}`, formData);
  }
