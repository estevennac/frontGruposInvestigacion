...
@Component({
  selector: 'app-editar-titulacion',
  templateUrl: './editar-titulacion.component.html',
  styleUrls: ['../estilosModales.component.scss']
})
export class EditarTitulacionComponent implements OnInit {
  titulacionForm: FormGroup;

  constructor(
    private dialogRef: MatDialogRef<EditarTitulacionComponent>,
