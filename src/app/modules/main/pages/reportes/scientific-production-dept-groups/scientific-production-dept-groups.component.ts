...
@Component({
  selector: 'vex-scientific-production-dept-groups',
  templateUrl: './scientific-production-dept-groups.component.html',
  styleUrls: ['./scientific-production-dept-groups.component.scss']
})
export class ScientificProductionDeptGroupsComponent implements OnInit {
