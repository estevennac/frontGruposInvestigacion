...
@Component({
  selector: 'vex-scientific-production-investigators',
  templateUrl: './scientific-production-investigators.component.html',
  styleUrls: ['./scientific-production-investigators.component.scss']
})
export class ScientificProductionInvestigatorsComponent implements OnInit {
