...
export class CargaMemoVicComponent implements OnInit {
    ...
    const input = event.target as HTMLInputElement;
        ...
        if (files && files.length > 0) {
          ...
          if (file.type === 'application/pdf') {
              ...
              const customFileName = `memo_VITT_Comite_${this.groupId}_${year}-${month}-${day}.pdf`;
  ...
  goBack() {
    ...
    this.router.navigate(["main/solicitudesV"],{state:{creationReqForm}});
  }
